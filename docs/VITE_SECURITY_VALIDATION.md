...
- The UNC case points only to `\\127.0.0.1\\jzmatrix-no-share` and requires launch-editor's explicit Windows UNC rejection message. It never names a public SMB host.
